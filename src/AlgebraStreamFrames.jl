...
mutable struct StreamFrame{T <: Any} <: AlgebraFrames.AbstractAlgebraFrame
	...
	algebra::Vector{Algebra{<:Any, 1}}  # Placeholder, not directly storing data
	...
	function StreamFrame(named_paths::Pair{String, String} ...)
        ...
        @info alg
		new{Symbol(:feature_file)}(paths, n, names, types, alg)  # Default type
	end
